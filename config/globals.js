...
module.exports.globals = {
  ...
  ****************************************************************************/
  ...
  // services: true,
  // HelpService: 'api/services/HelpService.js',
  ...
  ****************************************************************************/
  ...
  // models: true,
  // Modules: 'api/models/Modules.js',
  //Custom Global Vars for this platform
  modulesList: ['Dashboard', 'Communication', 'Listing', 'Marketing Analytics', 'Revenue', 'Polls', 'Accounts', 'App Link', 'Settings', 'User Timeline'],
  ageGroup: ['0-10', '11-20', '21-30', '31-40', '41-50', '51-60', '61-70', '71-125'],
  userGroup: ['Patient', 'Partner', 'Doctor'],
  modeOfCommunication: ['Email', 'SMS', 'Offers&Deals'],
